...
def stock_purchases():
    ...
    if stock_name == 'Amazon':
        ...
        stock_price = msft
    share_amount = (int(invest)//int(stock_price))
    ...
    print(f'{name} has ${invest} to invest and can buy {share_amount} shares of {stock_name} at the current price of ${stock_price}.')
